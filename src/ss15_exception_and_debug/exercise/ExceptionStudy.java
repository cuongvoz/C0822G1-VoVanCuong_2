...
public class ExceptionStudy {
    ...
    public static void triangleCheck(double x, double y, double z) throws IllegalTriangleException {
        if (x <= 0 || z <= 0 || y <= 0) {
            throw new IllegalTriangleException("Cạnh bạn nhập ko hợp lệ yêu cầu cạnh lớn hơn 0 hãy nhập lại");
        } else if (z >= y + x || y >= x + z || x >= y + z) {
            throw new IllegalTriangleException("Tổng 2 cạnh nhỏ hơn cạnh còn lại hãy nhập lại");
        } else {
